...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 010 ????? 00100 11", slti  , I, R(rd) = (int32_t)src1 < imm); // set less than immdiate
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  ,  N, s->dnpc = isa_raise_intr(R(17), s->pc), test()); 
