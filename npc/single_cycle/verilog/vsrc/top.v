...
module controlLogic(	// @[<stdin>:3:10]
  ...
  output [3:0]  test	// @[single_cycle/src/controlLogic.scala:6:14]
);
  ...
  wire [2:0] optype =
    inst[6:0] == 7'h13 | inst[6:0] == 7'h67
      ...
      : inst[6:0] == 7'h17 | inst[6:0] == 7'h37
          ? 3'h2
          : inst[6:0] == 7'h23 ? 3'h3 : inst[6:0] == 7'h6F ? 3'h4 : 3'h7;	// @[single_cycle/src/controlLogic.scala:32:{13,20}, :34:20, :35:20, :36:20, :37:20, :38:20, src/main/scala/chisel3/util/Mux.scala:141:16]
  wire       _GEN = optype == 3'h0;	// @[single_cycle/src/controlLogic.scala:51:18, src/main/scala/chisel3/util/Mux.scala:141:16]
  wire       _GEN_0 = optype == 3'h2;	// @[single_cycle/src/controlLogic.scala:51:18, src/main/scala/chisel3/util/Mux.scala:141:16]
  wire       _GEN_1 = optype == 3'h3;	// @[single_cycle/src/controlLogic.scala:51:18, src/main/scala/chisel3/util/Mux.scala:141:16]
  wire       _GEN_2 = optype == 3'h4;	// @[single_cycle/src/controlLogic.scala:51:18, src/main/scala/chisel3/util/Mux.scala:141:16]
  wire       _GEN_3 = _GEN_0 | _GEN_1;	// @[single_cycle/src/controlLogic.scala:42:12, :51:18, :66:16]
  wire       _GEN_4 = ~_GEN_1 & _GEN_2;	// @[single_cycle/src/controlLogic.scala:43:14, :51:18]
  wire       _GEN_5 = _GEN | _GEN_0 | _GEN_4;	// @[single_cycle/src/controlLogic.scala:43:14, :51:18, :56:18, :67:18]
  assign pcsel = _GEN ? inst[5] : ~_GEN_3 & _GEN_2;	// @[<stdin>:3:10, single_cycle/src/controlLogic.scala:42:12, :51:18, :55:{16,26}, :66:16]
  assign writeEn = _GEN_5;	// @[<stdin>:3:10, single_cycle/src/controlLogic.scala:51:18, :56:18, :67:18]
  assign immsel = _GEN ? 6'h0 : _GEN_0 ? 6'h1 : _GEN_1 | ~_GEN_2 ? 6'h0 : 6'h3;	// @[<stdin>:3:10, single_cycle/src/controlLogic.scala:44:13, :51:18, :57:17, :68:18, :81:17]
  assign asel = ~_GEN & (_GEN_0 | _GEN_4);	// @[<stdin>:3:10, single_cycle/src/controlLogic.scala:43:14, :51:18, :58:15, :69:15]
  assign bsel = _GEN_5;	// @[<stdin>:3:10, single_cycle/src/controlLogic.scala:51:18, :56:18, :67:18]
  assign alusel = _GEN ? {1'h0, inst[14:12]} : _GEN_0 ? {4{inst[5]}} : 4'h0;	// @[<stdin>:3:10, single_cycle/src/controlLogic.scala:42:12, :51:18, :60:{17,27}, :71:{17,29,34,54}]
  assign WBsel = _GEN ? {2'h0, inst[5]} : _GEN_3 ? 3'h0 : {2'h0, _GEN_2};	// @[<stdin>:3:10, single_cycle/src/controlLogic.scala:32:20, :42:12, :48:12, :51:18, :55:26, :61:16, :66:16, :72:16, :85:16, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign test = {1'h0, optype};	// @[<stdin>:3:10, single_cycle/src/controlLogic.scala:42:12, :89:11, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module Regfile(	// @[<stdin>:82:10]
  ...
  always @(posedge clock) begin	// @[<stdin>:83:11]
    if (reset) begin	// @[<stdin>:83:11]
      ...
      if (writeEn & writereg == 5'h1)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_1 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h2)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_2 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h3)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_3 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h4)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_4 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h5)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_5 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h6)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_6 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h7)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_7 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h8)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_8 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h9)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_9 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'hA)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_10 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'hB)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_11 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'hC)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_12 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'hD)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_13 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'hE)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_14 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'hF)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_15 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h10)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_16 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h11)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_17 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h12)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_18 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h13)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_19 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h14)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_20 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h15)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_21 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h16)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_22 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h17)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_23 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h18)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_24 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h19)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_25 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h1A)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_26 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h1B)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_27 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h1C)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_28 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h1D)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
        regs_29 <= data;	// @[single_cycle/src/Regfile.scala:27:21]
      if (writeEn & writereg == 5'h1E)	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:33:{23,32}]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:82:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:82:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:82:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:31];	// @[<stdin>:82:10]
    initial begin	// @[<stdin>:82:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:82:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:82:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:82:10]
        for (logic [5:0] i = 6'h0; i < 6'h20; i += 6'h1) begin
          _RANDOM[i[4:0]] = `RANDOM;	// @[<stdin>:82:10]
        end	// @[<stdin>:82:10]
        regs_1 = _RANDOM[5'h1];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_2 = _RANDOM[5'h2];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_3 = _RANDOM[5'h3];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_4 = _RANDOM[5'h4];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_5 = _RANDOM[5'h5];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_6 = _RANDOM[5'h6];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_7 = _RANDOM[5'h7];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_8 = _RANDOM[5'h8];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_9 = _RANDOM[5'h9];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_10 = _RANDOM[5'hA];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_11 = _RANDOM[5'hB];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_12 = _RANDOM[5'hC];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_13 = _RANDOM[5'hD];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_14 = _RANDOM[5'hE];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_15 = _RANDOM[5'hF];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_16 = _RANDOM[5'h10];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_17 = _RANDOM[5'h11];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_18 = _RANDOM[5'h12];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_19 = _RANDOM[5'h13];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_20 = _RANDOM[5'h14];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_21 = _RANDOM[5'h15];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_22 = _RANDOM[5'h16];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_23 = _RANDOM[5'h17];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_24 = _RANDOM[5'h18];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_25 = _RANDOM[5'h19];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_26 = _RANDOM[5'h1A];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_27 = _RANDOM[5'h1B];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_28 = _RANDOM[5'h1C];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_29 = _RANDOM[5'h1D];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_30 = _RANDOM[5'h1E];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
        regs_31 = _RANDOM[5'h1F];	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:82:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:82:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign rs1 = casez_tmp;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:35:{35,44}]
  assign rs2 = casez_tmp_0;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:36:{35,44}]
  assign x1 = regs_1;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
  assign x2 = regs_2;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
  assign x5 = regs_5;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
  assign x6 = regs_6;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
  assign x7 = regs_7;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
  assign x8 = regs_8;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
  assign x9 = regs_9;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
  assign x10 = regs_10;	// @[<stdin>:82:10, single_cycle/src/Regfile.scala:27:21]
endmodule

module adder(	// @[<stdin>:517:10]
  ...
  assign result = carry_with_result[31:0];	// @[<stdin>:517:10, single_cycle/src/ALU.scala:85:68, :87:33]
  assign overflow =
    A[31] == complement_of_B[31] & carry_with_result[31] != A[31];	// @[<stdin>:517:10, single_cycle/src/ALU.scala:84:29, :85:68, :90:{23,35,54,67,80,92}]
  assign carry = carry_with_result[32];	// @[<stdin>:517:10, single_cycle/src/ALU.scala:85:68, :88:33]
endmodule

module Shifter(	// @[<stdin>:573:10]
  ...
  assign out =
    left_right
      ...
      : _out_T_1[31:0];	// @[<stdin>:573:10, single_cycle/src/ALU.scala:106:16, :108:11, :109:{8,42,69}]
endmodule

module ALU(	// @[<stdin>:589:10]
  ...
  assign res = casez_tmp;	// @[<stdin>:589:10, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module ImmGen(	// @[<stdin>:752:10]
  ...
  assign imm =
    immsel == 6'h0
      ...
      : immsel == 6'h1
          ? {inst[31:12], 12'h0}
          : {{11{_sign_imm_T_21[20]}}, _sign_imm_T_21};	// @[<stdin>:752:10, single_cycle/src/ImmGen.scala:6:37, :19:{20,39}, :21:{20,35,43}, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

// external module BlackBoxRealAdd

module top(	// @[<stdin>:804:10]
  input         clock,	// @[<stdin>:805:11]
                reset,	// @[<stdin>:806:11]
  ...
  wire [3:0]  _cntlLogic_test;	// @[single_cycle/src/CPU.scala:21:25]
  wire [31:0] _pcvalue_T_2 = pc_REG + 32'h4;	// @[single_cycle/src/CPU.scala:27:45, :28:19]
  always @(posedge clock) begin	// @[<stdin>:805:11]
    if (reset)	// @[<stdin>:805:11]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:804:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:804:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:804:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:0];	// @[<stdin>:804:10]
    initial begin	// @[<stdin>:804:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:804:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:804:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:804:10]
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// @[<stdin>:804:10]
        pc_REG = _RANDOM[/*Zero width*/ 1'b0];	// @[<stdin>:804:10, single_cycle/src/CPU.scala:28:19]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:804:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:804:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  ...
  BlackBoxRealAdd stop (	// @[single_cycle/src/CPU.scala:64:20]
    .inst_ref  (4'h7),	// @[single_cycle/src/CPU.scala:21:25, :64:20]
    .inst_type (_cntlLogic_test)	// @[single_cycle/src/CPU.scala:21:25]
  );
  assign pc = pc_REG;	// @[<stdin>:804:10, single_cycle/src/CPU.scala:28:19]
  assign test_alu_res = _alu_res;	// @[<stdin>:804:10, single_cycle/src/CPU.scala:23:25]
endmodule
